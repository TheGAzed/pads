...
#define INFINITE_ALLOCATED_LIST  51
#define FINITE_ALLOCATED_LIST    52
#define INFINITE_REALLOC_LIST    53
#define FINITE_PRERPOCESSOR_LIST 54
...
static inline void foreach_list(list_s const * list, const operate_list_fn operate, void * args) {
    LIST_ASSERT(list && "[ERROR] 'list' parameter pointer is NULL.");
