...
SUITE (finite_preprocessor_queue_test) {
    ...
    // foevery
    RUN_TEST(FPQ_FOREVERY_01); RUN_TEST(FPQ_FOREVERY_02); RUN_TEST(FPQ_FOREVERY_03); RUN_TEST(FPQ_FOREVERY_04); RUN_TEST(FPQ_FOREVERY_05);
    RUN_TEST(FPQ_FOREVERY_06);
}
