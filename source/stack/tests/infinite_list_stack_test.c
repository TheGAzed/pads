...
SUITE (infinite_list_stack_test) {
    ...
    // foevery
    RUN_TEST(ILS_FOREVERY_01); RUN_TEST(ILS_FOREVERY_02); RUN_TEST(ILS_FOREVERY_03); RUN_TEST(ILS_FOREVERY_04); RUN_TEST(ILS_FOREVERY_05);
    RUN_TEST(ILS_FOREVERY_06); RUN_TEST(ILS_FOREVERY_07); RUN_TEST(ILS_FOREVERY_08);
}
