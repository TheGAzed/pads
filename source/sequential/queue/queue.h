...
#define LIST_ARRAY_QUEUE_CHUNK (1 << 5)
...
static inline void map_queue(queue_s const * queue, const manage_queue_fn manage, void * args) {
    QUEUE_ASSERT(queue && "[ERROR] 'queue' parameter pointer is NULL.");
...
#define PREPROCESSOR_QUEUE_SIZE (1 << 5)
