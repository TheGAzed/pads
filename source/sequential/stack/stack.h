...
#define INFINITE_LIST_STACK_MODE       1 // infinite list mode
#define FINITE_ALLOCATED_STACK_MODE    2 // finite preallocated memory mode
#define INFINITE_REALLOC_STACK_MODE    3 // infinite reallocable mode
...
// 'FINITE_PREPROCESSOR_STACK_MODE'.
...
// Check to make sure a valid stack mode is selected.
    ...
    (STACK_MODE != INFINITE_REALLOC_STACK_MODE) && (STACK_MODE != FINITE_PREPROCESSOR_STACK_MODE)
...
#elif STACK_MODE == FINITE_PREPROCESSOR_STACK_MODE
