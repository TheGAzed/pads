...
SUITE (finite_preprocessor_deque_test) {
    ...
    // forevery
    RUN_TEST(FPD_FOREVERY_01); RUN_TEST(FPD_FOREVERY_02); RUN_TEST(FPD_FOREVERY_03); RUN_TEST(FPD_FOREVERY_04);
    RUN_TEST(FPD_FOREVERY_05); RUN_TEST(FPD_FOREVERY_06);
}
