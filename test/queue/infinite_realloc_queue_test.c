...
TEST ILQ_01(void) {
    ...
    ASSERT_EQm("[ILQ-ERROR] Test queue head is not NULL.", NULL, test.elements);
...
TEST ILQ_35(void) {
    ...
    ASSERT_EQm("[ILQ-ERROR] Expected queue's 'elements' parameter to be NULL.", NULL, test.elements);
