...
TEST FPFL_CREATE_03(void) {
    ...
    ASSERT_EQm("[FPFL-ERROR] test double_list's size is not 0.", 0, test.size);
...
TEST FPFL_IS_EMPTY_01(void) {
    ...
    ASSERTm("[FPFL-ERROR] Expected double_list to be empty.", is_empty_forward_list(test));
...
TEST FPFL_IS_EMPTY_02(void) {
    ...
    ASSERT_FALSEm("[FPFL-ERROR] Expected double_list to not be empty.", is_empty_forward_list(test));
