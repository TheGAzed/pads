...
TEST IAFL_CREATE_03(void) {
    ...
    ASSERT_EQm("[IAFL-ERROR] test double_list's size is not 0.", 0, test.size);
    ASSERT_EQm("[IAFL-ERROR] test double_list's size is not NULL.", NULL, test.tail);
...
TEST IAFL_DESTROY_01(void) {
    ...
    ASSERT_EQm("[IAFL-ERROR] test double_list's size is not 0.", 0, test.size);
    ASSERT_EQm("[IAFL-ERROR] test double_list's tail is not NULL.", NULL, test.tail);
...
TEST IAFL_IS_EMPTY_01(void) {
    ...
    ASSERTm("[IAFL-ERROR] Expected double_list to be empty.", is_empty_forward_list(test));
...
TEST IAFL_IS_EMPTY_02(void) {
    ...
    ASSERT_FALSEm("[IAFL-ERROR] Expected double_list to not be empty.", is_empty_forward_list(test));
