...
TEST IRFL_CREATE_03(void) {
    ...
    ASSERT_EQm("[IRFL-ERROR] test double_list's size is not 0.", 0, test.size);
    ASSERT_EQm("[IRFL-ERROR] test double_list's size is not NULL.", NULL, test.elements);
    ASSERT_EQm("[IRFL-ERROR] test double_list's size is not NULL.", NULL, test.next);
...
TEST IRFL_DESTROY_01(void) {
    ...
    ASSERT_EQm("[IRFL-ERROR] test double_list's size is not 0.", 0, test.size);
    ASSERT_EQm("[IRFL-ERROR] test double_list's tail is not NULL.", NULL, test.elements);
    ASSERT_EQm("[IRFL-ERROR] test double_list's tail is not NULL.", NULL, test.next);
...
TEST IRFL_IS_EMPTY_01(void) {
    ...
    ASSERTm("[IRFL-ERROR] Expected double_list to be empty.", is_empty_forward_list(test));
...
TEST IRFL_IS_EMPTY_02(void) {
    ...
    ASSERT_FALSEm("[IRFL-ERROR] Expected double_list to not be empty.", is_empty_forward_list(test));
