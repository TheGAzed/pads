...
TEST IADL_22(void) {
    ...
    DOUBLE_LIST_DATA_TYPE element = remove_at_double_list(&test, test.size / 2);
    printf("%d ", element.sub_one);
    ASSERT_EQm("[IADL-ERROR] Expected middle element to be list size divided by 2", (int)(test.size / 2), element.sub_one);
