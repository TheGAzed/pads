...
/// @brief Tests if peeped first element is correct.
...
/// @brief Tests if peeped second added value is correct.
...
/// @brief Tests if peeped first value is correct after pushing and poping invalid value.
...
/// @brief Tests if peeped value is correct when reaching 'LIST_ARRAY_STACK_CHUNK' size.
...
/// @brief Tests if peeped value is correct when exceeding 'LIST_ARRAY_STACK_CHUNK' size by one.
...
/// @brief Tests if peeped element is correct when exceeding 'LIST_ARRAY_STACK_CHUNK' size by one
...
/// @brief Tests if peeped element is correct when pushing correct value first, then pushing 'LIST_ARRAY_STACK_CHUNK'
...
/// @brief Tests if peeped value is correct when reaching 'REALLOC_STACK_CHUNK' size.
...
/// @brief Tests if peeped value is correct when exceeding 'REALLOC_STACK_CHUNK' size by one.
...
/// @brief Tests if peeped element is correct when exceeding 'REALLOC_STACK_CHUNK' size by one
/// and then poping back to 'LIST_ARRAY_STACK_CHUNK' size.
...
/// @brief Tests if peeped value is correct after filling stack to 'PREPROCESSOR_STACK_SIZE' with invalid values.
...
/// @brief Tests if first added peeped value is correct after filling stack to 'PREPROCESSOR_STACK_SIZE' with
