...
SUITE (infinite_list_stack_test) {
    ...
    RUN_TEST(ILS_03); RUN_TEST(ILS_04); RUN_TEST(ILS_05); RUN_TEST(ILS_06);
    RUN_TEST(ILS_07); RUN_TEST(ILS_08); RUN_TEST(ILS_09); RUN_TEST(ILS_10);
    RUN_TEST(ILS_11); RUN_TEST(ILS_12); RUN_TEST(ILS_13); RUN_TEST(ILS_14);
    RUN_TEST(ILS_15); RUN_TEST(ILS_16); RUN_TEST(ILS_17); RUN_TEST(ILS_18);
    RUN_TEST(ILS_19); RUN_TEST(ILS_20); RUN_TEST(ILS_21); RUN_TEST(ILS_22);
    RUN_TEST(ILS_23); RUN_TEST(ILS_24); RUN_TEST(ILS_25); RUN_TEST(ILS_26);
    RUN_TEST(ILS_27); RUN_TEST(ILS_28); RUN_TEST(ILS_29); RUN_TEST(ILS_30);
    RUN_TEST(ILS_31); RUN_TEST(ILS_32); RUN_TEST(ILS_33); RUN_TEST(ILS_34);
    RUN_TEST(ILS_35); RUN_TEST(ILS_36); RUN_TEST(ILS_37); RUN_TEST(ILS_38);
    RUN_TEST(ILS_39); RUN_TEST(ILS_40); RUN_TEST(ILS_41); RUN_TEST(ILS_42);
    RUN_TEST(ILS_43); RUN_TEST(ILS_44); RUN_TEST(ILS_45); RUN_TEST(ILS_46);

    RUN_TEST(ILS_47); RUN_TEST(ILS_48);
}
