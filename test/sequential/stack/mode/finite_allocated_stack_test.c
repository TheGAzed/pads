...
SUITE (finite_allocated_stack_test) {
    ...
    // map
    RUN_TEST(FAS_MAP_01); RUN_TEST(FAS_MAP_02); RUN_TEST(FAS_MAP_03); RUN_TEST(FAS_MAP_04); RUN_TEST(FAS_MAP_05);
    RUN_TEST(FAS_MAP_06);
}
