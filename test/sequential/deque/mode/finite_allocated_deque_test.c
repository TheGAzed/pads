...
SUITE (finite_allocated_deque_test) {
    ...
    // map
    RUN_TEST(FAD_MAP_01); RUN_TEST(FAD_MAP_02); RUN_TEST(FAD_MAP_03); RUN_TEST(FAD_MAP_04);
    RUN_TEST(FAD_MAP_05); RUN_TEST(FAD_MAP_06);
}
