...
SUITE (infinite_list_deque_test) {
    ...
    // map
    RUN_TEST(ILD_MAP_01); RUN_TEST(ILD_MAP_02); RUN_TEST(ILD_MAP_03); RUN_TEST(ILD_MAP_04);
    RUN_TEST(ILD_MAP_05); RUN_TEST(ILD_MAP_06); RUN_TEST(ILD_MAP_07); RUN_TEST(ILD_MAP_08);
}
