...
SUITE (infinite_list_queue_test) {
    ...
    // map
    RUN_TEST(ILQ_MAP_01); RUN_TEST(ILQ_MAP_02); RUN_TEST(ILQ_MAP_03); RUN_TEST(ILQ_MAP_04);
    RUN_TEST(ILQ_MAP_05); RUN_TEST(ILQ_MAP_06); RUN_TEST(ILQ_MAP_07); RUN_TEST(ILQ_MAP_08);
}