...
SUITE (finite_allocated_queue_test) {
    ...
    // map
    RUN_TEST(FAQ_MAP_01); RUN_TEST(FAQ_MAP_02); RUN_TEST(FAQ_MAP_03); RUN_TEST(FAQ_MAP_04); RUN_TEST(FAQ_MAP_05);
    RUN_TEST(FAQ_MAP_06);
}
